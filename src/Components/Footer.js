        ...
        <div className="row">
         ...
         <div className="row">
            <div className="col-md-12">
             <p className="footer-content">1  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p>
             <p className="footer-content">2  Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae</p>
             <p className="footer-content">2  Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae</p>
             </div>
        </div>
        <div className="row mt-4">
            <div className="col-md-6">
                <p className="footer-content">© Copyright 2021 Structure Financial, Inc. All Rights Reserved.
